...
def criar_cliente(clientes):
    ...
    if filtrar_cliente(cpf, clientes):
        print("\nX Já existe cliente com esse CPF!")
        return
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print("\nX Cliente não encontrado, fluxo de criação de conta encerrado!")
        return
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print("\nX Operação inválida, por favor selecione novamente a operação desejada.")
